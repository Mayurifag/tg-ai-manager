...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('autoread_service_messages', sa.Boolean(), server_default='0', nullable=False),
        ...
        # Other settings
        sa.Column('autoread_bots', sa.Text(), server_default="'@lolsBotCatcherBot'", nullable=True),
